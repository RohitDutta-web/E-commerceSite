...
export default function RestirctedAnnouncepage() {
  return (
    <>
      <NavBar />
      <div className="bg-[#233142] min-h-screen flex justify-center items-center flex-col absolute top-0 w-screen">
      <svg
        version="1.1"
        xmlns="http://www.w3.org/2000/svg"
        xmlnsXlink="http://www.w3.org/1999/xlink"
        viewBox="0 0 1000 1000"
        className="whistle animate-wiggle"
      >
      ...
      <h1 className="mt-[-100px] text-[#facf5a] text-9xl font-extrabold text-center bg-transparent">403</h1>
      <h2 className="text-[#455d7a]  uppercase text-center font-semibold bg-transparent text-3xl">Not this time, access forbidden!</h2>
    </div>
    </>
  )
}
